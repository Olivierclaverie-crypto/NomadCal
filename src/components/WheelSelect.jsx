...
function SingleWheel({ items, selectedIdx, onChange }) {
  ...
  return (
    <div
      ...
      style={{ position:"relative", height:VISIBLE_H, overflow:"hidden", cursor:"ns-resize", userSelect:"none" }}
    >
      ...
      <div style={{ position:"absolute", inset:0, pointerEvents:"none", zIndex:3, background:`linear-gradient(to bottom, ${C.surface} 0%, transparent 22%, transparent 78%, ${C.surface} 100%)` }}/>
