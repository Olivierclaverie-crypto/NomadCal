...
6. **Icône « état vide »** : SVG maison `icons/`, née sous **charte Orchard** (olive/corail, stroke par taille → `Orchard_CHARTE_GRAPHIQUE_*`). *Cosmétique — fermé jusqu'à finition V1.*
