...
- ⚠️ **Garde-fou contraste (mesuré WCAG)** : le duo signature olive profond/corail Orchard = **3,54:1** → autorisé UNIQUEMENT en gras (500+) et ≥ 13px. Jamais de corail profond sur olive profond (1,69:1 — illisible, mesuré et rejeté le 30-07).
...
### Graisses Phenomena — 3 seulement (sur les 7 existantes)
| Graisse | Usage |
|---|---|
| **Bold 700** | Grands titres, chiffres |
| **Medium 500** | Sous-titres, boutons, badges, petits libellés |
| **Light 300** | Très grands formats affiche uniquement |

### Règle du petit (plein soleil iPhone)
- **En dessous de 14px : Phenomena TOUJOURS en Medium (500) + letter-spacing +0,3px.**
...
- Rubriques : titre Phenomena Medium olive Orchard (peut être en capitales + letter-spacing), corps en police système encre, blocs sur olive voile.
...
6. **Plancher 12px partout, Medium+espacement sous 14px.**
